...
public class Preferencess {
    ...
    static final String KEY_USER_TEREGISTER ="id", KEY_PASS_TEREGISTER ="password";
    static final String KEY_USERNAME_SEDANG_LOGIN = "Username_logged_in";
    static final String KEY_STATUS_SEDANG_LOGIN = "Status_logged_in";

    /** Pendlakarasian Shared Preferencess yang berdasarkan paramater context */
    private static SharedPreferences getSharedPreference(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context);
    }

    /** Deklarasi Edit Preferencess dan mengubah data
    ...
    /** Deklarasi Edit Preferencess dan menghapus data, sehingga menjadikannya bernilai default
