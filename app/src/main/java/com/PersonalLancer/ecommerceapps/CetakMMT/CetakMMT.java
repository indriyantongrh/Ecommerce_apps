...
public class CetakMMT extends AppCompatActivity implements View.OnClickListener {
    ...
    CardView btncekharga, btnuploadgambar, btnpesanmmt;
    ImageView  image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnpesanmmt = findViewById(R.id.btnpesanmmt);
        btnpesanmmt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String jumlah_harga = txthargammt.getText().toString();
   ...
   ////     Toast.makeText(this, "ini id ke-"+ id, Toast.LENGTH_SHORT).show();
    ...
    private void PostDataCustomers(final String namalengkap, final String nomortelepon, final String nomor_invoice, final String tanggal_pesan, final String lebar, final String panjang, final String jumlah_pesanan, final String gambar, final String jumlah_harga) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("jenis_cetak", "Pesanan Cetak MMT");
                ...
                params.put("lebar", txtlebar.getText().toString()+"Meter");
                params.put("panjang", txtpanjang.getText().toString()+"Meter");
                params.put("jumlah_pesanan", txtjumlahorder.getText().toString()+"Lembar");
                params.put("gambar", getStringImage(decoded));
                params.put("jumlah_harga", txthargammt.getText().toString());
    ...
    private void goToPayment(){
        ...
        intent = new Intent(CetakMMT.this, OrderSukses.class);
        finish();
