...
public class CetakUndanganPernikahan extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView txthargaundangan,txthargakertas;
    ...
    CardView btncekharga, btnuploadgambar, btnpesanundangan;
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cetak_undangan_pernikahan);
        ...
        txthargaundangan = findViewById(R.id.txthargaundangan);
    ...
    ///    Toast.makeText(this, "ini id ke-"+ id, Toast.LENGTH_SHORT).show();
        ...
        btncekharga.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
...

                {
                    ...
                    txthargaundangan.setText(formatRupiah.format(hitungan));
                    ...
                    Toast toast = Toast.makeText(CetakUndanganPernikahan.this, "Masukan Lebar dan panjang ukuran MMT", Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
        ...
        btnpesanundangan = findViewById(R.id.btnpesanundangan);
        btnpesanundangan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String jumlah_harga = txthargaundangan.getText().toString();
    ...
    private void PostDataCustomers(final String namalengkap, final String nomortelepon, final String nomor_invoice, final String tanggal_pesan, final String lebar, final String panjang, final String jumlah_pesanan, final String gambar, final String jumlah_harga) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("jumlah_harga", txthargaundangan.getText().toString());
    ...
    private void goToPayment(){
        ...
        intent = new Intent(CetakUndanganPernikahan.this, OrderSukses.class);
        finish();
