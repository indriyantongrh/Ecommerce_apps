package com.example.ryudigitalprinting.Adapter;
...
import com.example.ryudigitalprinting.KonfirmasiPesana.DetailKonfirmasi;
import com.example.ryudigitalprinting.Model.ModelStatusPesanan;
import com.example.ryudigitalprinting.R;
import com.example.ryudigitalprinting.StatusOrder.DetailStatusPesanan;

import java.util.ArrayList;

public class AdapterStatusPesanan extends RecyclerView.Adapter<AdapterStatusPesanan.ViewHolder> implements Filterable {
    ...
    public AdapterStatusPesanan(Context context, ArrayList<ModelStatusPesanan> arrayList) {
    ...
    @Override
    public AdapterStatusPesanan.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_status_pesanan, viewGroup, false);
        return new AdapterStatusPesanan.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterStatusPesanan.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private TextView txt_invoice,txt_jeniscetak, txt_tanggalpesan, txt_lebar, txt_panjang,
